...
class LoadingbuttonsDemo extends StatefulWidget {
  const LoadingbuttonsDemo({super.key});

  @override
  State<LoadingbuttonsDemo> createState() => _LoadingbuttonsDemoState();
}

class _LoadingbuttonsDemoState extends State<LoadingbuttonsDemo> {
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(onPressed: (){
                  ...
                  child:
                  Image.asset('assets/images/Ellipse 2.25.png',color: Colors.white,width: 30,height: 30,)
              ),
            ),
            ...
            Container(
              ...
              child: ElevatedButton(onPressed: (){
                  ...
                  child:
                  Image.asset('assets/images/Ellipse 2.25.png',color: Colors.black,width: 30,height: 30,)
              ),
            ),
