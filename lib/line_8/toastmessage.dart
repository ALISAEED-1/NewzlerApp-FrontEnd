...
class ToastmessageDemo extends StatefulWidget {
  const ToastmessageDemo({super.key});

  @override
  State<ToastmessageDemo> createState() => _ToastmessageDemoState();
}

class _ToastmessageDemoState extends State<ToastmessageDemo> {
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(onPressed: (){
                ...
                if(emial.text.length < 8)
                {
                  ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text("Please enter a valid code",style: GoogleFonts.poppins(
