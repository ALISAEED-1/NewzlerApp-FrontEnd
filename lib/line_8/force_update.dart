...
class ForceUpdateDemo extends StatefulWidget {
  const ForceUpdateDemo({super.key});

  @override
  State<ForceUpdateDemo> createState() => _ForceUpdateDemoState();
}

class _ForceUpdateDemoState extends State<ForceUpdateDemo> {
  @override
